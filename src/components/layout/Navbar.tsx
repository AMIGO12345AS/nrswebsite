    ...
    <nav className="sticky top-0 z-50 bg-primary text-primary-foreground shadow-lg">
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-1">
          ...
          <Link
            to={`/${other}`}
            className="ml-4 flex items-center gap-1.5 rounded-md border border-primary-foreground/30 px-3 py-1.5 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground hover:border-accent"
          >
