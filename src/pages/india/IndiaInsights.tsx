...
const articles = [
  {
    title: "Cross-Border Compliance: India-GCC Best Practices",
    excerpt: "Navigating the regulatory landscape for businesses operating across India and the Gulf — key frameworks and practical steps.",
    date: "January 2024",
    category: "Compliance",
    reading: "7 min read",
    featured: true,
  ...
  {
    title: "Why Every SME Needs a Virtual CFO",
    excerpt: "The strategic advantage of fractional finance leadership for growing businesses in today's competitive market.",
    date: "December 2023",
    category: "CFO Services",
    reading: "5 min read",
  },
  {
    title: "Zoho ERP: Transforming Business Operations",
    excerpt: "How cloud-based enterprise resource planning is helping mid-market companies streamline operations and reduce costs.",
    date: "November 2023",
    category: "Technology",
    reading: "6 min read",
  },
