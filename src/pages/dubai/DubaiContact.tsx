    ...
    <>
      ...
      <section className="py-28 bg-background relative overflow-hidden">
        ...
        <div className="container max-w-6xl mx-auto relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <input type="tel" id="phone" value={formState.phone} onChange={e => setFormState({ ...formState, phone: e.target.value })} className="w-full bg-background/50 border border-border/60 hover:border-border rounded-2xl px-5 py-4 text-[15px] focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/50 transition-all placeholder:text-muted-foreground/30" placeholder="+971 50 123 4567" />
                    </div>
                  </div>
          ...
          {/* Map */}
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="rounded-3xl border border-border overflow-hidden bg-card min-h-[420px] shadow-2xl relative z-10">
            <iframe
