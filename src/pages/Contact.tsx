  ...
  return (
    <>
      <section ref={heroRef} className="relative h-[70vh] min-h-[500px] flex items-end overflow-hidden bg-foreground">
        <link rel="preload" as="image" href={contactHero} />
        <img fetchPriority="high" loading="eager" src={contactHero} alt="Office reception" className="absolute inset-0 w-full h-full object-cover object-center" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="flex flex-col justify-center">
              ...
              <h2 className="text-4xl md:text-[52px] font-heading font-bold tracking-[-0.02em] leading-[1.1] mb-8">
                Partner-led support,<br />close to your business.
              </h2>
              <p className="text-[17px] text-muted-foreground leading-[1.8] font-light mb-8 md:mb-12 max-w-md">
                Founded in 2016, NRS and Associates supports clients through audit, taxation, compliance, NRI advisory, and cross-border work from Kerala to Dubai.
              </p>
              ...
              <div className="space-y-8 border-l border-border pl-5 md:pl-8">
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <div className="text-[12px] font-semibold tracking-widest uppercase text-muted-foreground/60 mb-2">Manjeri HQ</div>
                    <p className="text-[16px] text-foreground leading-[1.7] font-medium">
                      Head office and partner-led delivery base
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <div className="text-[12px] font-semibold tracking-widest uppercase text-muted-foreground/60 mb-2">Calicut Branch</div>
                    <p className="text-[16px] text-foreground leading-[1.7] font-medium">
                      Regional support for growing businesses in North Kerala
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-[16px] text-foreground leading-[1.7] font-medium">
                      Cross-border advisory for UAE and GCC clients
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@nrsassociates.in" className="group/link inline-flex items-center gap-2 text-[16px] text-foreground leading-[1.7] font-medium hover:text-accent transition-colors">
                      info@nrsassociates.in
                ...
                <AnimatePresence mode="wait">
                  {submitted ? (
                    ...
                    <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                      <h3 className="font-heading font-bold text-2xl mb-2">Request a consultation</h3>
                      <p className="text-[14px] text-muted-foreground mb-6 md:mb-8">Tell us what you need and we will route it to the right partner.</p>
                      <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <input type="tel" id="phone" value={formState.phone} onChange={e => setFormState({ ...formState, phone: e.target.value })} className="w-full bg-background border border-border hover:border-muted-foreground/30 rounded-xl px-4 py-3 text-[14px] md:py-3.5 md:text-[15px] focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/30 transition-all placeholder:text-muted-foreground/30" placeholder="+91 98765 43210" />
                          </div>
                        </div>
