...
const principles = [
  { icon: Heart, title: "Integrity", desc: "Transparent advice, direct partner access, and a long-term view of client trust." },
  { icon: Star, title: "Excellence", desc: "High-quality execution across audit, tax, compliance, and advisory work." },
  { icon: Lightbulb, title: "Innovation", desc: "Modern systems and practical workflows that make compliance easier." },
  { icon: Users, title: "Client-Centricity", desc: "Tailored solutions for corporates, NRIs, entrepreneurs, and families." },
];
  ...
  return (
    <>
      <section ref={heroRef} className="relative h-[70vh] min-h-[500px] flex items-end overflow-hidden bg-foreground">
        <link rel="preload" as="image" href={aboutHero} />
        <img fetchPriority="high" loading="eager" src={aboutHero} alt="Modern boardroom" className="absolute inset-0 w-full h-full object-cover object-center" />
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} className="lg:col-span-5">
              ...
              <motion.h2 variants={fadeUp} custom={1} className="text-4xl md:text-[52px] font-heading font-bold tracking-[-0.02em] leading-[1.1] text-foreground">
                Built on partner-led trust<br />and practical expertise
              </motion.h2>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="lg:col-span-7 lg:pt-16">
              <p className="text-[19px] md:text-[22px] leading-[1.8] text-foreground/80 font-light mb-8">
                Established in 2016, NRS and Associates is a partner-led chartered accountancy firm providing audit, taxation, corporate compliance, NRI advisory, bank audit, and cross-border support.
              </p>
              <p className="text-[16px] leading-[1.8] text-muted-foreground">
                With more than 700 clients, offices in Manjeri, Calicut, and Dubai, and over a decade of professional experience, the firm combines technical depth with practical execution.
              </p>
            </motion.div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-0 md:gap-0 border border-border rounded-3xl overflow-hidden">
            ...
            >
              ...
              <p className="text-[20px] md:text-[32px] font-heading font-light leading-[1.4] tracking-[-0.02em] text-foreground">
                To be the <span className="text-accent font-semibold">trusted partner</span> for businesses, NRIs, and families that need clarity across tax, compliance, and cross-border decisions.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[20px] md:text-[32px] font-heading font-light leading-[1.4] tracking-[-0.02em] text-foreground">
                To deliver trusted <span className="font-semibold text-foreground">financial, advisory, and compliance solutions</span> that help clients grow across India and the UAE.
              </p>
            </motion.div>
          </div>
        </div>
