import { ClipboardCheck, LineChart, Monitor, Globe, ArrowUpRight, ArrowRight } from "lucide-react";
import { motion } from "framer-motion";
import { Link } from "react-router-dom";
import serviceAudit from "@/assets/service-audit.jpg";
import serviceCfo from "@/assets/service-cfo.jpg";
import serviceErp from "@/assets/service-erp.jpg";
import serviceCrossborder from "@/assets/service-crossborder.jpg";

const services = [
  {
    icon: ClipboardCheck, title: "Audit & Assurance", num: "01",
    desc: "Statutory, internal, LLP, tax, and bank audits designed to improve transparency and control.",
    items: ["Statutory financial audits", "Internal audits and process reviews", "Bank audit and risk assessment"],
    image: serviceAudit,
  },
  {
    icon: LineChart, title: "Direct Tax Services", num: "02",
    desc: "Planning, filing, representation, and advisory for businesses, professionals, and NRIs.",
    items: ["Income tax returns and planning", "Assessments and litigation support", "NRI and cross-border tax advisory"],
    image: serviceCfo,
  },
  {
    icon: Monitor, title: "Corporate Compliance", num: "03",
    desc: "Incorporation, MCA filings, restructuring, and secretarial compliance for growing entities.",
    items: ["Company and LLP formation", "Annual and event-based filings", "Restructuring and regulatory support"],
    image: serviceErp,
  },
  {
    icon: Globe, title: "Cross-Border Advisory", num: "04",
    desc: "India-UAE and GCC support for FEMA, repatriation, setup, and international transactions.",
    items: ["FEMA and NRI advisory", "DTAA and international tax", "Business setup outside India"],
    image: serviceCrossborder,
  },
];
        ...
        <div className="container relative z-10 max-w-5xl">
          ...
          >
            ...
            <h1 className="text-5xl md:text-[68px] font-heading font-bold text-white max-w-3xl leading-[1.05] tracking-[-0.02em] mb-6">
              Services Built for<br />Compliance and Growth
            </h1>
            <p className="text-[16px] text-white/40 max-w-lg leading-relaxed font-light">
              From audit and tax to corporate compliance, NRI advisory, and overseas setup, every service is designed to be practical, precise, and partner-led.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-5 lg:gap-6">
            {services.map((s, i) => (
              ...
              >
                ...
                {/* Arrow indicator */}
                <div className="absolute top-10 right-10 w-9 h-9 flex items-center justify-center rounded-full opacity-0 group-hover:opacity-100 group-hover:bg-accent transition-all duration-500">
