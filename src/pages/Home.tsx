        ...
        <div className="container py-14 relative z-10">
          <div className="grid grid-cols-3">
            {[
              ...
              { value: "3", label: "Kerala & Dubai Offices" }].
              map((stat, i) =>
                <motion.div
                  key={i}
        ...
        <div className="container relative z-10">
          <div className="grid md:grid-cols-2 gap-10 md:gap-20 items-center">
            ...
            <motion.div
              ...
              {[
                { title: "Partner-led", desc: "Direct access to senior advisors" },
                { title: "Tailored", desc: "Solutions shaped around each client" },
                { title: "Trust", desc: "Transparent and long-term relationships" },
                { title: "Cross-border", desc: "Support across India and the UAE" }].
                map((p, i) =>
                  <motion.div
                    key={i}
                    initial={{ opacity: 0, y: 20 }}
